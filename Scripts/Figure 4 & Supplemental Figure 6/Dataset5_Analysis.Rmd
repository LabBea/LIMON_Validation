...
Make LIMON Object
```{r}
SimData <- read.csv(here("Data", "GLV_SimData", "Dataset_5","GLV_Cov_0.01.csv"))
...
##################################################################################
original_data <- read.csv(here("Data", "GLV_SimData", "Dataset_5","GLV_0.01.csv"))
...
# Make fake LIMON Object to Pass to Network Inference Steps
##################################################################################
original_data <- read.csv(here("Data", "GLV_SimData", "Dataset_5","GLV_Cov_0.01.csv"))
original_data <- original_data %>% column_to_rownames("X")
...
# Add CovariateStrength 
Merged_T10$CovariateStrength <- 0.010
```
...
Make LIMON Object
```{r}
SimData <- read.csv(here("Data", "GLV_SimData", "Dataset_5","GLV_Cov_0.10.csv"))
SimData <- column_to_rownames(SimData, "X")
...
# Make fake LIMON Object to Pass to Network Inference Steps
##################################################################################
original_data <- read.csv(here("Data", "GLV_SimData", "Dataset_5","GLV_0.10.csv"))
original_data <- original_data %>% column_to_rownames("X")
...
# Make fake LIMON Object to Pass to Network Inference Steps
##################################################################################
original_data <- read.csv(here("Data", "GLV_SimData", "Dataset_5","GLV_Cov_0.10.csv"))
original_data <- original_data %>% column_to_rownames("X")
...
# Add CovariateStrength 
Merged_T20$CovariateStrength <- 0.10
```
...
Make LIMON Object
```{r}
SimData <- read.csv(here("Data", "GLV_SimData", "Dataset_5","GLV_Cov_1.0.csv"))
SimData <- column_to_rownames(SimData, "X")
...
# Make fake LIMON Object to Pass to Network Inference Steps
##################################################################################
original_data <- read.csv(here("Data", "GLV_SimData", "Dataset_5","GLV_1.0.csv"))
original_data <- original_data %>% column_to_rownames("X")
...
# Make fake LIMON Object to Pass to Network Inference Steps
##################################################################################
original_data <- read.csv(here("Data", "GLV_SimData", "Dataset_5","GLV_Cov_1.0.csv"))
original_data <- original_data %>% column_to_rownames("X")
...
# Add CovariateStrength 
Merged_T50$CovariateStrength <- 1.0
```



## 2.4 - Covariate Strength = 8.0
...
Make LIMON Object
```{r}
SimData <- read.csv(here("Data", "GLV_SimData", "Dataset_5","GLV_Cov_8.0.csv"))
SimData <- column_to_rownames(SimData, "X")
...
# Make fake LIMON Object to Pass to Network Inference Steps
##################################################################################
original_data <- read.csv(here("Data", "GLV_SimData", "Dataset_5","GLV_8.0.csv"))
original_data <- original_data %>% column_to_rownames("X")
...
# Make fake LIMON Object to Pass to Network Inference Steps
##################################################################################
original_data <- read.csv(here("Data", "GLV_SimData", "Dataset_5","GLV_Cov_8.0.csv"))
original_data <- original_data %>% column_to_rownames("X")
...
# Add CovariateStrength 
Merged_T75$CovariateStrength <- 8.0
```



## 2.5 - Covariate Strength = 15.0
...
Make LIMON Object
```{r}
SimData <- read.csv(here("Data", "GLV_SimData", "Dataset_5","GLV_Cov_15.0.csv"))
SimData <- column_to_rownames(SimData, "X")
...
# Make fake LIMON Object to Pass to Network Inference Steps
##################################################################################
original_data <- read.csv(here("Data", "GLV_SimData", "Dataset_5","GLV_15.0.csv"))
original_data <- original_data %>% column_to_rownames("X")
...
# Make fake LIMON Object to Pass to Network Inference Steps
##################################################################################
original_data <- read.csv(here("Data", "GLV_SimData", "Dataset_5","GLV_Cov_15.0.csv"))
original_data <- original_data %>% column_to_rownames("X")
...
# Add CovariateStrength 
Merged_T100$CovariateStrength <- 15.0
```
...
Merged_T10c <- Merged_T10[,c("Source","Sink","Time","L_Edge_weight",
                            "O_Edge_weight","Cov_Edge_weight","Recovery","CovariateStrength")]
...
```{r}
#write.csv(Subject_sens_data_full, here("Output", "Dataset_5", "Subject_sens_data_full.csv"))
#write.csv(Subject_sens_data_taxa, here("Output", "Dataset_5","Subject_sens_data_taxa.csv"))
Subject_sens_data_full <- read.csv(here("Output", "Dataset_5", "Subject_sens_data_full.csv"))
Subject_sens_data_taxa <- read.csv(here("Output","Dataset_5", "Subject_sens_data_taxa.csv"))
```
