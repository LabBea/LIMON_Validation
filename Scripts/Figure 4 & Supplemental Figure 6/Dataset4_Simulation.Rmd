---
title: "Data Simulation - Network Sparsity"
output: html_notebook
---

In this script, simulate 5 different datasets based on Connectance. Each will be a GLV model of 50 taxa, 50 subjects over 10 time points with the same starting correlation matrix. N values are 0.10, 0.20, 0.50, 0.75, and 0.90 connectance. The saved values are the counts+cov and counts+cov+0s. 
...
# 2. Simulate Connectance = 0.10
*** 
__Simulate Counts__  
Simulate GLV for 50 individuals, 50 species, 10 timepoints, Connectance = 0.10
```{r}
# Set seed
set.seed(12345)
...
Save the Counts
```{r}
write.csv(meta_counts, here("Data","GLV_SimData", "Dataset_4","GLV_0.10.csv"))
write.csv(Long_data_new, here("Data","GLV_SimData", "Dataset_4","GLV_Cov_0.10.csv"))
write.csv(zero_data1, here("Data","GLV_SimData", "Dataset_4","GLV_CovZero_0.10.csv"))
```



# 3. Simulate Connectance = 0.20
*** 
__Simulate Counts__  
Simulate GLV for 50 individuals, 50 species, 10 timepoints, Connectance = 0.20
```{r}
# Set seed
set.seed(12345)
...
Save the Counts
```{r}
write.csv(meta_counts, here("Data","GLV_SimData", "Dataset_4","GLV_0.20.csv"))
write.csv(Long_data_new, here("Data","GLV_SimData", "Dataset_4","GLV_Cov_0.20.csv"))
write.csv(zero_data1, here("Data","GLV_SimData", "Dataset_4","GLV_CovZero_0.20.csv"))
```




# 4. Simulate Connectance = 0.50
*** 
__Simulate Counts__  
Simulate GLV for 50 individuals, 50 species, 10 timepoints, Connectance = 0.50
```{r}
# Set seed
set.seed(12345)
...
Save the Counts
```{r}
write.csv(meta_counts, here("Data","GLV_SimData", "Dataset_4","GLV_0.50.csv"))
write.csv(Long_data_new, here("Data","GLV_SimData", "Dataset_4","GLV_Cov_0.50.csv"))
write.csv(zero_data1, here("Data","GLV_SimData", "Dataset_4","GLV_CovZero_0.50.csv"))
```



# 5. Simulate Connectance = 0.75
*** 
__Simulate Counts__  
Simulate GLV for 50 individuals, 50 species, 10 timepoints, Connectance = 0.75
```{r}
# Set seed
set.seed(12345)
...
Save the Counts
```{r}
write.csv(meta_counts, here("Data","GLV_SimData", "Dataset_4","GLV_0.75.csv"))
write.csv(Long_data_new, here("Data","GLV_SimData", "Dataset_4","GLV_Cov_0.75.csv"))
write.csv(zero_data1, here("Data","GLV_SimData", "Dataset_4","GLV_CovZero_0.75.csv"))
```



# 5. Simulate Connectance = 0.90
*** 
__Simulate Counts__  
Simulate GLV for 50 individuals, 50 species, 10 timepoints, Connectance = 0.90
```{r}
# Set seed
set.seed(12345)
...
Save the Counts
```{r}
write.csv(meta_counts, here("Data","GLV_SimData", "Dataset_4","GLV_0.90.csv"))
write.csv(Long_data_new, here("Data","GLV_SimData", "Dataset_4","GLV_Cov_0.90.csv"))
write.csv(zero_data1, here("Data","GLV_SimData", "Dataset_4","GLV_CovZero_0.90.csv"))
```
