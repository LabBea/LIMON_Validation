---
title: "SE & LIONNESS - Dataset 2g 100/50"
output: html_notebook
---


In this script, we will be testing how well SE does at recovering individual networks with LIONESS using Dataset 2g - 100 subjects, 50 taxa. 
...
```{r}
saveRDS(Dataset2g_Res, here("Dataset2g_Res100sbj.rds"))
Dataset2g_Res <- readRDS(here("Dataset2g_Res100sbj.rds"))
```
...
Save the data
```{r}
saveRDS(Dataset2g_Res, here("Output", "SE_Lionness", "Dataset2g_Res_100sbj.rds"))

write.csv(Combined_data_sortededge, here("Output", "SE_Lionness", "Edges_100sbj.csv"))
```
